...
function ProfilePictures({ avatar }) {
      ...
      <div className="w-full flex items-center gap-x-4">
        <div className="relative w-20 h-20 rounded-full outline outline-offset-2 outline-1 outline-primary overflow-hidden">
          <label
            ...
            className="cursor-pointer absolute rounded-full inset-0 bg-transparent"
          >
            {avatar ? (
              <img
              ...
              <div className="h-full w-full flex justify-center items-center bg-blue-50/50">
                <HiOutlineCamera className="w-7 h-auto text-pretty" />
              </div>
            )}
          </label>
        ...
        <button
          ...
          onClick={handleDeleteImage} // Handle delete action
        >
          Delete
        </button>
      </div>
