...
function Ariticles() {
  ...
  return (
    ...
    >
      ...
      <button className="flex mx-auto text-primary px-6 py-2 rounded-lg items-center gap-x-3 font-semibold border-2 border-primary hover:text-white hover hover:bg-primary transition-all duration-500 ease-in-out">
